...
class _CardType1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Card(
      //la elevacion hace que el color se valla a oscureciendo de manera escalable
      elevation: elevation,
      child:  Padding(
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Card(
      //clipBehavior evita que los hijos se salgan de su contenido, genera como border radius
      ...
      child:  Stack(
        children: [
          Image.network(
            ...
            height: 350,
            //esto hace la imagen se adapte a sus tamaño
            fit: BoxFit.cover,
